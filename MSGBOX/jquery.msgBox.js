...
function msg (options) {
    ...
    var divContainer = "<div class=\"msgBoxContainer\"><div class=\"msgBoxImage\"><img src=\"./MSGBOX/Images/" + image + "\"/></div><div class=\"msgBoxContent\"><p><span>" + options.content + "</span></p></div></div>";
    ...
    var top = windowHeight / 2 - height / 2 + window.pageYOffset;
    ...
    function show() {
        ...
        $("div.msgBox").animate({ "opacity": 1, "top": top, "left": 0}, 200);
        ...
        $(window).bind("resize", function (e) {
            ...
            $("div.msgBox").css({"opacity": 1, "top": top, "left": 0});
        });
    }
